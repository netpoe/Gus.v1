...
var b=this.getItems(a);if(o.call(this,a),b&&b.length)for(var c=0,f=b.length;f>c;c++){var g=b[c];e(g,this.filteredItems)}},m.prototype.shuffle=function(){for(var a=0,b=this.items.length;b>a;a++){var c=this.items[a];c.sortData.random=Math.random()}this.options.sortBy="random",this._sort(),this._layout()},m.prototype._noTransition=function(a){var b=this.options.transitionDuration;this.options.transitionDuration=0;var c=a.call(this);return this.options.transitionDuration=b,c},m.prototype.getFilteredItemElements=function(){for(var a=[],b=0,c=this.filteredItems.length;c>b;b++)a.push(this.filteredItems[b].element);return a},m}var g=a.jQuery,h=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^\s+|\s+$/g,"")},i=document.documentElement,j=i.textContent?function(a){return a.textContent}:function(a){return a.innerText},k=Object.prototype.toString,l=Array.prototype.indexOf?function(a,b){return a.indexOf(b)}:function(a,b){for(var c=0,d=a.length;d>c;c++)if(a[c]===b)return c;return-1};"function"==typeof define&&define.amd?define(["outlayer/outlayer","get-size/get-size","matches-selector/matches-selector","isotope/js/item","isotope/js/layout-mode","isotope/js/layout-modes/masonry","isotope/js/layout-modes/fit-rows","isotope/js/layout-modes/vertical"],f):"object"==typeof exports?module.exports=f(require("outlayer"),require("get-size"),require("desandro-matches-selector"),require("./item"),require("./layout-mode"),require("./layout-modes/masonry"),require("./layout-modes/fit-rows"),require("./layout-modes/vertical")):a.Isotope=f(a.Outlayer,a.getSize,a.matchesSelector,a.Isotope.Item,a.Isotope.LayoutMode)}(window),function(a,b){"function"==typeof define&&define.amd?define(b):a.transformicons=b()}(this||window,function(){"use strict";var a={},b="tcon-transform",c={transform:["click","touchstart"],revert:["click","touchstart"]},d=function(a){return"string"==typeof a?Array.prototype.slice.call(document.querySelectorAll(a)):"undefined"==typeof a||a instanceof Array?a:[a]},e=function(a){return"string"==typeof a?a.toLowerCase().split(" "):a},f=function(a,b,f){var h=(f?"remove":"add")+"EventListener",i=d(a),j=i.length,k={};for(var l in c)k[l]=b&&b[l]?e(b[l]):c[l];for(;j--;)for(var m in k)for(var n=k[m].length;n--;)i[j][h](k[m][n],g)},g=function(b){a.toggle(b.currentTarget)};return a.add=function(b,c){return f(b,c),a},a.remove=function(b,c){return f(b,c,!0),a},a.transform=function(c){return d(c).forEach(function(a){a.classList.add(b)}),a},a.revert=function(c){return d(c).forEach(function(a){a.classList.remove(b)}),a},a.toggle=function(c){return d(c).forEach(function(c){a[c.classList.contains(b)?"revert":"transform"](c)}),a},a}),function(){"use-strict";$(document).ready(function(){$(".disable-anchors a").click(function(a){a.preventDefault()}),$("[data-href]").click(function(){var a,b,c,d;b=window.location.pathname.split("/"),a=b[b.length-1],c=b[b.length-2],d={},d[c]=a,window.history.pushState(d,"",a),document.location.replace($(this).data("href"))}),transformicons.add(".tcon")})}.call(this),function(){"use-strict";$(document).ready(function(){var a;a=new ScrollMagic,a.scrollTo(function(a){TweenMax.to(window,.5,{scrollTo:{y:a}})}),$(document).on("click","a[href^=#]",function(b){var c;c=$(this).attr("href"),$(c).length>0&&!c.match(/nav/g)&&!c.match(/carousel/g)&&(b.preventDefault(),a.scrollTo(c))})})}.call(this),function(){$(document).ready(function(){var a,b,c,d,e,f,g;b=$("body #section-scroll"),e=$("body #section-scroll ul"),c=$("[data-section-scroll]"),f=function(a){return a=a.replace(/[ÀÁÂÃÄÅ]/g,"A"),a=a.replace(/[àáâãäå]/g,"a"),a=a.replace(/[ÈÉÊË]/g,"E"),a=a.replace(/[é]/g,"e"),a=a.replace(/[Í]/g,"I"),a=a.replace(/[í]/g,"i"),a=a.replace(/[Ú]/g,"U"),a=a.replace(/[ú]/g,"u"),a=a.replace(/[Ó]/g,"O"),a=a.replace(/[ó]/g,"o"),a.replace(/[^a-z0-9]/gi,"")},d=new ScrollMagic,g=[],$.each(c,function(a,b){var c,h,i,j,k,l;l=".section-scroll-"+a,j=$(b).data("section-scroll"),h=j.toString().toLowerCase(),h=f(h),h=h.split(" ").join("-"),i=".scroll-ref-"+a,$(b).addClass("section-scroll-"+a),$(b).attr("id",h),g.push(h),k='<li><a href="#'+h+'"class="animated bounceInRight ad-'+2*a+" scroll-ref-"+a+' atm-scroll-item">'+j+"</a></li>",e.append(k),c=new ScrollScene({triggerHook:"onLeave",triggerElement:l,duration:$(b).height()}).setClassToggle(i,"active").addTo(d)}),e.find("li:first-child a").addClass("active"),g.shift(),$.each(c,function(a,b){var c,d;c=g.shift(),d='<a class="scroll-down scroll-down-sq size lg"href="#'+c+'"rel="nofollow">down</a>',void 0!==c&&$(b).append(d)}),a=new ScrollScene({triggerHook:"onEnter",triggerElement:".section-scroll-3"}).addTo(d),a.on("enter",function(){$(".btn-apply").addClass("bounceInRight")})})}.call(this);